            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="platform" id="platform" required
                        ...
                        <option value="PS1" {{ old('platform', $game->platform) === 'PS1' ? 'selected' : '' }}>PlayStation 1 (PSX)</option>
                        <option value="PS2" {{ old('platform', $game->platform) === 'PS2' ? 'selected' : '' }}>PlayStation 2</option>
                        <option value="PS3" {{ old('platform', $game->platform) === 'PS3' ? 'selected' : '' }}>PlayStation 3</option>
                        <option value="PS4" {{ old('platform', $game->platform) === 'PS4' ? 'selected' : '' }}>PlayStation 4</option>
                        <option value="PS5" {{ old('platform', $game->platform) === 'PS5' ? 'selected' : '' }}>PlayStation 5</option>
                    </select>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @if($game->status === 'rented')
                        ...
                        <span class="text-xs text-retro-pink mt-1 block font-mono">[!] Status locked because game is currently active in a rental.</span>
                    @endif
                </div>
            </div>
